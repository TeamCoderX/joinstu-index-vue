        ...
        <div style="padding: 1em;" v-if="status.updating == false">
            ...
            <div class="text-end" style="border-width: 44px;">
                ...
                <div v-else>
                    ...
                    <div>
                        <span>剩餘</span>
                        <span style="color: var(--bs-blue);font-size: 24px;">{{ 30 - (new Date().getDate() - new Date(cardData.date).getDate()) }}</span>
                        <span>天</span>
                    </div>
                </div>
            </div>
            <div style="max-width: calc(100vw); word-break: break-all;">
                ...
                <div class="text-center">
                    ...
                    <button v-if="isSupported == false" class="btn btn-primary center" type="button" @click="support">我要附議</button>
                    <button v-else-if="isSupported == true" class="btn btn-secondary center" type="button" disabled>已附議</button>
                    <button v-else-if="isSupported == 'adm'" class="btn btn-secondary center" type="button" disabled>管理員不可參與</button>
                    <button v-else class="btn btn-primary center" type="button" disabled>
